...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Owner.full_name'
        db.alter_column(u'dog_owner', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Owner.full_name'
        db.alter_column(u'dog_owner', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=30))
