...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DogPhoto.img_width'
        db.add_column(u'dog_dogphoto', 'img_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)

        # Adding field 'DogPhoto.img_height'
        db.add_column(u'dog_dogphoto', 'img_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DogPhoto.img_width'
        db.delete_column(u'dog_dogphoto', 'img_width')

        # Deleting field 'DogPhoto.img_height'
        db.delete_column(u'dog_dogphoto', 'img_height')
