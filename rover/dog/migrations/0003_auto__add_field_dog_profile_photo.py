...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dog.profile_photo'
        db.add_column(u'dog_dog', 'profile_photo',
                      self.gf('stdimage.fields.StdImageField')(default='dog/test/', max_length=100, upload_to='dog', thumbnail_size={'width': 150, 'force': True, 'height': 150}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dog.profile_photo'
        db.delete_column(u'dog_dog', 'profile_photo')
